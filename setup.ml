...
(* OASIS_START *)
(* DO NOT EDIT (digest: c1c73d120c0e8fe12b25340622a60c7b) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_logic", []))];
          ...
          ("solver",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_solver", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/zayac/picologic";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Logic"; "Cnf"; "Picosat"; "Sat"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_logic.ml"});
               Executable
                 ({
                     cs_name = "test_solver";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_solver.ml"});
               Doc
                 ({
                     cs_name = "picologic";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/picologic";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "y3\145ª\001&\150\136Ê·ÚY\131_rë";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
