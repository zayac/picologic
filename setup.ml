...
(* OASIS_START *)
(* DO NOT EDIT (digest: f184e4e1d5e5fb1656e6a206318410b6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          synopsis = "Lightweight logic library for OCaml";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Logic"; "Picosat"; "Picologic"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "¶LX×ö\026;ç\140\t½gdîä\128";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
